...
Once a parser function is called, it will read a token list and create a union data variable. Every parser is passed in with a \verb|code| parameter as well which is a 
