...
\begin{itemize}
    ...
    \item Functions to serialize and deserialize these data structures. We needed this for sending data to other nodes across the netw
\end{itemize}
