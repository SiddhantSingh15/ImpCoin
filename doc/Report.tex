...
\begin{itemize}
    \item Suitable data structures to model blocks, transactions, a variable length list of transactions and a blockchain. We were able to make use of some of our 
    \item Functions to hash
\end{itemize}
